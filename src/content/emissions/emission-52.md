...
- **What's new ?** : les bases de l'accessibilité web et présentation d'« [Emulate vision deficiencies](https://developer.chrome.com/docs/devtools/rendering/apply-effects) », futur outil de Google Chrome pour simuler les déficiences visuelles.
- **Agenda** : Carinne partage les ressources utiles aux personnes handicapées pendant le confinement : attestations en FALC, assouplissements pour les personnes autistes, et contacts locaux à Toulouse.

Côté musique, deux pauses : [Clarika - L'astronaute](https://www.youtube.com/watch?v=HhyfJXUj3gY) et [Arcade Fire - No Cars Go](https://www.youtube.com/watch?v=T703EHtdPwo)

*Émission animée par Guénaël, Michel, Corinne et Carinne. Technique et montage : Marco. Programmation musicale : Julien. Coordination : Carinne.*
